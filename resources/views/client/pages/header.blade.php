                    ...
                    <ul>
                        ...
                        <li><a href="#">Pages</a>
                            <ul class="header__menu__dropdown">
                                <li><a href="{{route('shoping-cart.index')}}">Shop Details</a></li>
                                <li><a >Shoping Cart</a></li>
                                <li><a href="{{ route('check-out.index')}}">Check Out</a></li>
                ...
                <div class="header__cart">
                    <ul>
                        ...
                        @php
                         ...
                         @endphp
                        <li><a href="{{ route('shoping-cart.index')}}" ><i class="fa fa-shopping-bag" ></i> <span id="total_product">{{ $total }}</span></a></li>
                    </ul>
                    @php
                        $totalPrice = 0;
                        if(session()->has('cart')){
